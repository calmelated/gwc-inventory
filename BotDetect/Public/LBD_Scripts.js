if (typeof(BotDetect) == "undefined") { // start single inclusion guard
  ...
  BotDetect.prototype.PlaySound = function() {
    if (document.getElementById) {
      ...
      if (BotDetect.DetectIOS() || BotDetect.DetectAndroid()) {
  ...
  BotDetect.prototype.PlayMobileSound = function() {
    ...
    var self = this;
    BotDetect.RegisterHandler(sound, 'ended', function() { self.EnableSoundIcon(); self = null;}, false);
  ...
  BotDetect.prototype.StartSoundPlayback = function() {
